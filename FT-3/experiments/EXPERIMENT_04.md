...
This creates:
- `FT-3/experiments/exp4_unseen_tags`
- `FT-3/experiments/exp4_unseen_tags/experiment4_summary.json`
...
Change:
```python
cfg.split_dir = "FT-3/experiments/exp4_unseen_tags"
...
python3 scripts/evaluate_experiment4.py \
  ...
  --experiment-dir FT-3/experiments/exp4_unseen_tags
```
