...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("input", nargs="?", default="norming/jsonl/df_children_sentences.jsonl")
    parser.add_argument("output", nargs="?", default="norming/jsonl/df_children_sentences.csv")
